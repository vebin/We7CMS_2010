...
<asp:Content ID="Content1" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript" src="../Ajax/jquery/jquery-ui.min.js"></script>
    <script type="text/javascript" src="../cgi-bin/Menu/jquery.easywidgets.js"></script>
    <script type="text/javascript" src="../cgi-bin/Menu/mywidgets.js"></script>
    <h2 class="title">
        <img id="RoleImage" src="../Images/icons_home.gif" alt="我的工作台"/>
        <asp:Label ID="RoleLabel" runat="server" Text="我的工作台"></asp:Label>
        <span class="summary">
            <asp:Label ID="SummaryLabel" runat="server" Text=""></asp:Label>
        </span>
        <div id="buttonShow">
            <a href="#" onclick="$.fn.ShowEasyWidgets(); return false" title="显示所有挂件，包括以前关掉的">显示所有挂件</a>
        </div>
    </h2>
    <div class="widget-place" id="widget-place-1">
        <uc2:wid_myprocess ID="wid_myprocess1" runat="server"></uc2:wid_myprocess>
        <uc1:SiteProfile ID="wid_siteprofile1" runat="server"></uc1:SiteProfile>
        <uc4:wid_guide ID="wid_guide" runat="server"></uc4:wid_guide>
    </div>
    <div class="widget-place" id="widget-place-2">
        <uc5:wid_Shop ID="wid_Shop1" runat="server"></uc5:wid_Shop>
        <uc6:wid_Product ID="wid_Product1" runat="server"></uc6:wid_Product>
        <uc7:wid_article ID="wid_article2" runat="server" ChannelID="{33a2857b-fa4d-428c-b841-3c4877356c79}" PageSize="10" IncludeChildren="true"></uc7:wid_article>
    </div>
</asp:Content>