<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SiteProfile.ascx.cs" Inherits="We7.CMS.Web.Admin.tools.widget.SiteProfile" %>
    ...
    <div class="widget-content">
        <div class="inside">
            <table width="90%" style="text-align:center;">
                ...
                <tr>
                    <td>
                        今日浏览量：<asp:Label ID="TodayPVLabel" runat="server" Text="LabelTodayVisitors"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        本周评论数：<asp:Label ID="LabelWeekComments" runat="server" Text="LabelWeekCommentss"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
